...
class InMemoryTaskManagerTest {
    ...
    @Test
    void getAllTasks() {
        Task task = new Task("Test getAllTasks", "Test getAllTasks description", TaskStatus.NEW);
    ...
    void getAllSubtasks() {
        ...
        taskManager.addEpic(epic);
        Subtask subtask = new Subtask("Test getAllSubtasks", "Test getAllSubtasks description", TaskStatus.NEW, epic.getId());
    ...
    @Test
    void getTaskById() {
        Task task = new Task("Test getTaskById", "Test getTaskById description", TaskStatus.NEW);
        taskManager.addTask(task);
    ...
    void getSubtaskById() {
        ...
        taskManager.addEpic(epic);
        Subtask subtask = new Subtask("Test getSubtaskById", "Test getSubtaskById description", TaskStatus.NEW, epic.getId());
        taskManager.addSubtask(subtask);
    ...
    @Test
    void addTask() {
        Task task = new Task("Test addTask", "Test addTask description", TaskStatus.NEW);
        taskManager.addTask(task);
    ...
    void addSubtask() {
        ...
        taskManager.addEpic(epic);
        Subtask subtask = new Subtask("Test addSubtask", "Test addSubtask description", TaskStatus.NEW, epic.getId());
        taskManager.addSubtask(subtask);
    ...
    void updateTask() {
        ...
        Task updatedTask = new Task("Test updateTask updated", "Test updateTask updated description", TaskStatus.IN_PROGRESS);
    ...
    void updateSubtask() {
        ...
        taskManager.addEpic(epic);
        Subtask subtask = new Subtask("Test updateSubtask", "Test updateSubtask description", TaskStatus.NEW, epic.getId());
        taskManager.addSubtask(subtask);

        Subtask updatedSubtask = new Subtask("Test updateSubtask updated", "Test updateSubtask updated description", TaskStatus.IN_PROGRESS, epic.getId());
    ...
    @Test
    void deleteTaskById() {
        Task task = new Task("Test deleteTaskById", "Test deleteTaskById description", TaskStatus.NEW);
        taskManager.addTask(task);
    ...
    void deleteSubtaskById() {
        ...
        taskManager.addEpic(epic);
        Subtask subtask = new Subtask("Test deleteSubtaskById", "Test deleteSubtaskById description", TaskStatus.NEW, epic.getId());
        taskManager.addSubtask(subtask);
    ...
    @Test
    void deleteTasks() {
        Task task1 = new Task("Test deleteTasks 1", "Test deleteTasks 1 description", TaskStatus.NEW);
        Task task2 = new Task("Test deleteTasks 2", "Test deleteTasks 2 description", TaskStatus.NEW);
    ...
    void deleteSubtasks() {
        ...
        taskManager.addEpic(epic);
        Subtask subtask1 = new Subtask("Test deleteSubtasks 1", "Test deleteSubtasks 1 description", TaskStatus.NEW, epic.getId());
        Subtask subtask2 = new Subtask("Test deleteSubtasks 2", "Test deleteSubtasks 2 description", TaskStatus.NEW, epic.getId());
    ...
    void getSubtasksOfEpic() {
        ...
        taskManager.addEpic(epic);
        Subtask subtask1 = new Subtask("Test getSubtasksOfEpic 1", "Test getSubtasksOfEpic 1 description", TaskStatus.NEW, epic.getId());
        Subtask subtask2 = new Subtask("Test getSubtasksOfEpic 2", "Test getSubtasksOfEpic 2 description", TaskStatus.NEW, epic.getId());
        taskManager.addSubtask(subtask1);
        taskManager.addSubtask(subtask2);
    ...
    @Test
    void getHistory() {
        Task task = new Task("Test getHistory", "Test getHistory description", TaskStatus.NEW);
        taskManager.addTask(task);
